...
public class Xyz {
		...
		public static void main(String[] args) {
			...
			while(true) {
				...
				switch(choice) {
				case 1:
					System.out.println("Enter collegeno:");
				    ...
				    case 2:
				    	...
				    	break;
				    case 3:
				    	System.out.println("Enter college name for search");
				    	collegenm= sc.next();
				    	int search=0;
				    	for(int i=0;i<al.size();i++) {
				    ...
				    case 5:
				    	...
				    	System.out.println("Enter college nume for search");
				    	collegenm= sc.next();
				    	System.out.println("college location for change");
				    	collegelc=sc.next();
	                       for(int i=0;i<al.size();i++) {
				    		if(al.get(i).getCollegenm().contains(collegenm)) {
				    			College c1=al.get(i);
